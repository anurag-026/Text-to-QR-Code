...
class AnimatedBackground extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final tween = MultiTween<_ColorTweenProps>()
      ..add(
          _ColorTweenProps.color1,
          ColorTween(begin: Colors.red, end: Color.fromARGB(255, 241, 198, 5)),
          Duration(seconds: 3))
      ..add(
          _ColorTweenProps.color2,
          ColorTween(
              begin: Color.fromARGB(255, 236, 9, 9),
        ...
        return Container(
          decoration: BoxDecoration(
            gradient: LinearGradient(
              colors: [
                value.get(_ColorTweenProps.color1),
                value.get(_ColorTweenProps.color2)
              ],
